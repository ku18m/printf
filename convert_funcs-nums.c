 ...
 */
unsigned int convert_di(va_list args, buffer *output,
 ...
 * Return: The number of bytes stored to the buffer.
 */
unsigned int convert_b(va_list args, buffer *output,
		unsigned char flags, int wid, int prec, unsigned char len)
{
	unsigned int num;
 ...
 * Return: The number of bytes stored to the buffer.
 */
unsigned int convert_o(va_list args, buffer *output,
		unsigned char flags, int wid, int prec, unsigned char len)
{
 ...
 * Return: The number of bytes stored to the buffer.
 */
unsigned int convert_u(va_list args, buffer *output,
		unsigned char flags, int wid, int prec, unsigned char len)
{
	unsigned long int num;
	unsigned int ret = 0;
